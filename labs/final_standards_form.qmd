...
This is the form you will turn in (via [Moodle](https://moodle.smith.edu/mod/assign/view.php?id=1039310)) to identify what aspects of your final project you feel demonstrate the learning objectives as described in the course syllabus [standards table](https://adv-r-programming.github.io/Adv-R-Reader/syllabus/#standards). This is your last opportunity to raise your proficiency levels in the course. You *must* turn in a *rendered* version of this document. 

I will be looking at the version of your repository on your **main** branch as it is at **9:25am, 5/8/2023**. After this time the repository will lock; *you will not be able to push to the repository or make any changes (such as merges)*. No extensions will be given for this deadline outside of emergency circumstances. This is your final product.
...
<DESCRIBE HOW YOUR WORK RELATES TO THE STANDARD DESCRIPTION *ON THE SYLLABUS*. RELATE THIS DESCRIPTION TO THE LINKED FILE AND LINE NUMBERS PROVIDED. IF REFERANCING MULTIPLE LINES, EXPLAIN THE RELEVANT PORTIONS AND LINE NUMBERS IN THIS TEXT.>
