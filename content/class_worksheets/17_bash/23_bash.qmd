...
Before you can install the game, you will first need to install the tools get get the dependencies (what the game needs to run). First, install homebrew using the following. It will take a few mins.
```
