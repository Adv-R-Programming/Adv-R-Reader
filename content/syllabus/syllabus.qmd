...
colnames(standards) = c("Category", "Standard", "Does Not Meet Standard", "Progressing Toward Standard", "Near Standard", "Meets Standard", "Exceeds Standard", "Individual Standard")
...
For a full list of assignments and due dates, please see the course [schedule](/Adv-R-Reader/#schedule).
...
knitr::kable(standards[,-1], escape = FALSE) %>%
  ...
  column_spec(7, background = "#A2CD5A")
```
...
[Q: So if I reach "Exceeds Standard" and fulfill the individual standard on a quiz for a topic early in the semester, I can just skip those questions for the rest of the class?]{.question}

[A: Theoretically yes, but I would recommend you answer all questions to make sure you're not letting your knowledge slip.]{.answer}
